...
export const translations = {
  tr: {
    ...
    location: "TED Bolu Koleji",
    heroTitle: "2025 NASA Space Apps Challenge için kayıtlar açıldı!",
    heroSubtitle: "4-5 Ekim tarihlerinde Bolu'da gerçekleşecek dünyanın en büyük hackathonunun bir parçası olun.",
  ...
  en: {
    ...
    location: "TED Bolu College",
    heroTitle: "Registration for the 2025 NASA Space Apps Challenge is now open!",
    heroSubtitle: "Be a part of the world's largest hackathon on October 4-5 in Bolu.",
